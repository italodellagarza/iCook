          ...
          children: <Widget>[
            Positioned(
              ...
              children: <Widget>[
                IgnorePointer(
                    child: Container(
                    color: Colors.white.withOpacity(0.5), // comment or change to transparent color
                    height: 150.0,
                    width: 150.0,
                  ),
                ),
                ...
                Transform.translate(
                  offset: Offset.fromDirection(getRadiansFromDegree(180),degTwoTranslationAnimation.value * 100),
                  child: Transform(
